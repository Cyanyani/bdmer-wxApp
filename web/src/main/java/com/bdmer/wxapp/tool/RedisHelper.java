...
public class RedisHelper {
    ...
    public Set<String> keys(String pattern) {
        LOG.info("[操作redis]-获取keys：" + pattern);
    ...
    public void set(String key, Object data) {
        ...
        LOG.info("[操作redis]-set：" + key + ":"+ value);
    ...
    public <T> T get(String key, Class<T> beanType) {
        T obj = JSONObject.parseObject(redisTemplate.opsForValue().get(key), beanType) ;
        return obj;
    }
